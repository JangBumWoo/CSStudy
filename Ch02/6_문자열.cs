...
namespace Ch02
{
    internal class _6_문자열
    {
        static void Main6(string[] args)
        {
            ...
            // 문자열 index
            Console.WriteLine("'G'인덱스 : "+greeting.IndexOf('G')); // 앞에서부터
            Console.WriteLine("'M'인덱스 : "+greeting.IndexOf('M'));
            Console.WriteLine("'o'인덱스 : "+greeting.IndexOf('o')); // G'o'od
            Console.WriteLine("'o'인덱스 : "+greeting.LastIndexOf('o')); // 뒤에서부터 찾음 M'o'r


            // 문자열 자르기
            Console.WriteLine("greeting 0~4까지 문자열: " +greeting.Substring(0, 4));
                // 0부터 length 4, 아래는 5부터 leghth 7
            Console.WriteLine("greeting 5~7까지 문자열: " +greeting.Substring(5, 7));
