...
namespace Ch03
{
    internal class _5_배열
    {
        static void Main(string[] args)
        {
            ...
            // 배열 원소 출력
            Console.WriteLine("arr1의 첫번째 원소: " + arr1[0]);
            Console.WriteLine("arr2의 세번째 원소: " + arr2[2]);
            Console.WriteLine("arr3의 네번째 원소: " + arr3[3]);
            ...
            // 배열 반복물
            for (int i = 0; i < arr1.Length; i++) // 길이만큼 배열
            {
                Console.WriteLine("arr1[{0}] : {1}", i, arr1[i]);
            }

            foreach (int num in arr2) // 다섯번 반복
            {
                Console.Write(num + " ");
